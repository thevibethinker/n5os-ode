...
- Provenance: `artifact.md` → `artifact.provenance.md` (or embedded section)
...
---
## Note: Slippage‑Aware Exports (2025-10-21)

- Ensure exports preserve decision briefs + provenance blocks so downstream tools don’t re‑introduce slippage.
- Include “talking‑points.md” per artifact when language capture occurs.
