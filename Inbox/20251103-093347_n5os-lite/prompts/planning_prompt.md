# N5OS Planning Discipline
**Operational Framework for System Design**

**Version:** 1.0 (N5OS Lite)  
**Created:** 2025-11-03  
**Purpose:** Tactical planning framework for AI-assisted system work

---

## Purpose

Tactical planning framework for building systems with AI assistance. Translates philosophical DNA into executable workflows. Load this before any significant system building, refactoring, or architectural work.
...
**Guidance:** Gravitate toward determinism. Start squishy for exploration, migrate toward deterministic as system stabilizes.
...
- "call an AI"
- "query an AI service"
(You're prompting the AI to call something external—it's already the AI)

✅ **DO say:** 
- "Transform X to Y format"
- "Analyze this content for patterns"
- "Extract structured data from this text"
- "Apply [specific technique] to this problem"

**Why:** Direct instruction > meta-prompting.
...
- Script orchestrates (deterministic), AI provides intelligence (squishy)
- Don't force AI to manage infrastructure
...
**Why:** AI editing existing code has higher failure rate than generating new code.
...
- Data format many files depend on
...
- **Recommendation:** SQLite for personal systems
...
- **Decision factors:** See language selection guidelines
- **When to switch:** Performance bottleneck, wrong tool for job

### When You Hit One
1. **STOP** - Don't proceed without careful consideration
2. **Nemawashi** - Explore 2-3 alternatives explicitly
3. **Document** - Write trade-offs, failure modes, cost to reverse
4. **Record** - Add decision to trap door registry
5. **Review** - Revisit in 3 months—was this the right call?
...
### Code Quality
- Use modern path libraries (not string manipulation)
...
### File Quality
- `.md` for documentation (human-readable first)
...
**Progress Reporting:** Report honest progress.
