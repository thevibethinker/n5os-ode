---
description: Import personal prompts into N5 OS with standardized conversion
tags:
- prompts
- ai
tool: true
...
3. **Register Command**
   - Add entry to `Prompts/recipes.jsonl (index only)`
...
grep "{command-name}" Prompts/recipes.jsonl (index only)
