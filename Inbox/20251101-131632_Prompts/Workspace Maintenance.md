---
description: Automatically scans workspace root, identifies files that need organization, removes duplicates, and categorizes files into appropriate directories.
tags:
tool: true
---
