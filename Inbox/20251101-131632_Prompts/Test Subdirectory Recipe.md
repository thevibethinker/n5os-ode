...
This is a test recipe located in `Prompts/System/` to verify that Zo's recipe system supports subdirectory organization.
...
**If This Fails:**  
Revert to flat structure by moving all recipes back to `/home/workspace/Prompts/` root.
