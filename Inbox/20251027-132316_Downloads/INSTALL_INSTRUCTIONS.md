...
Download `file n5_bootstrap_critical.tar.gz`    from ParentZo workspace to your local machine.
...
- ✅ `file N5/config/commands.jsonl`    (104 command registry entries)

### Core Documentation

- ✅ `file Documents/N5.md`    (161 lines - system overview)
- ✅ `file N5/prefs/prefs.md`    (314 lines - preferences index)
