...
echo "   1. Initialize a build: python3 N5/scripts/init_build.py my-build"
echo "   2. Run contract gate: python3 N5/scripts/build_contract_check.py my-build"
echo "   3. Validate the plan: python3 Skills/pulse/scripts/pulse.py validate my-build"
echo "   4. See Skills/pulse/SKILL.md for full documentation"
