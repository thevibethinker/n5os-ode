---
date: '2025-10-09T22:00:00Z'
last-tested: '2025-10-09T22:00:00Z'
generated_date: '2025-10-09T22:00:00Z'
checksum: idea_compounder_v1_0_0
tags: ['strategic', 'ideation', 'iteration', '[COMPANY]']
category: strategic
priority: p2
related_files: ['N5/commands/strategic-partner.md', 'N5/scripts/strategic_partner_session.py']
anchors:
  input: /home/workspace/N5/commands/idea-compounder.md
  output: /home/workspace/N5/sessions/strategic-partner/
---
...
**Initial idea:**
```
"What if we added AI-powered role recommendation to [COMPANY]?"
```
...
employers use [COMPANY] for it vs. just posting on LinkedIn?
...
[COMPANY] data. Employers post roles, candidates get smart matches.
...
**Initial idea:**
```
"Should we do usage-based pricing for [COMPANY]?"
```
