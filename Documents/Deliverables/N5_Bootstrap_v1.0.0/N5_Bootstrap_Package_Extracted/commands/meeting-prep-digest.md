...
**Exclusions:**
- All-internal meetings (only @my[COMPANY].com or @theapply.ai)
...
#### Coordination (`{CORD}`)
```
[LOG]  — Coordinate with [STAKEHOLDER][ILS]  — Coordinate with Ilse
```
...
---
Please send pitch deck in advance to vrijen@my[COMPANY].com.
```
...
| Tag | Note in Digest |
|-----|----------------|
| `[LOG]` | "**Note:** Coordinate with [STAKEHOLDER]on scheduling and agenda" |
...
---
Please send resume in advance to vrijen@my[COMPANY].com.
```
...
---
Please send job descriptions in advance to vrijen@my[COMPANY].com.
```
...
**Note:** Coordinate with [STAKEHOLDER]on scheduling and agenda
...
**Check if meeting:**
- Has only internal attendees (@my[COMPANY].com)
