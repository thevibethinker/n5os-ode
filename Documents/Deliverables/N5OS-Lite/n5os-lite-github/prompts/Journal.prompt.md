...
| `@Temptation Check-In` | Non-judgmental urge awareness | 3-5 min |

Each reflection is a guided conversation—I ask adaptive questions, you respond, and at the end I compile and save the entry to your journal database.
...
python3 N5/scripts/journal.py new temptation
...
| `temptation` | Urge awareness check-in |
| `journal` | General journaling |
| `idea` | Idea capture |

## Database

Entries stored in: `N5/data/journal.db`
