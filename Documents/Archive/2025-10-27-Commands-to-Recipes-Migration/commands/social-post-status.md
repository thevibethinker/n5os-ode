---
description: |
  Update social media post status and move file to appropriate folder.
  
  Supports status transitions with URL tracking for published posts.
  Always dry-run first for safety (P7).
