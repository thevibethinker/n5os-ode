---
command: warm-intro-generate
description: Generate warm intro blurbs and emails from a meeting's B07 WARM_INTRO_BIDIRECTIONAL block (with double opt-in support).
category: intros
workflow: deliverables
script: /home/workspace/N5/scripts/warm_intro_generator.py
---
# warm-intro-generate
