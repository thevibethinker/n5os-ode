...
**Internal strategic document — not for external distribution**

---

## 1. Thesis

Careerspan is a **talent sourcing engine disguised as a career coaching platform**. By embedding in communities and giving candidates genuine value (career coaching), it captures signal at the source—before candidates hit job boards—and builds pipelines of pre-engaged, pre-profiled talent that traditional sourcing can't touch.
...
## 3. The Careerspan Advantage

### 3.1 Community Embedding Model (The Moat)

**The insight:** Communities don't let recruiters in. But they *will* let career coaches in—because coaching serves their members, not extracts from them.

**Proven traction:**

- **Peace Corps** — Access to 7,000+ returnees annually, service-minded, globally experienced
- **Emory University** — Elite institution, career services integration
- **Columbia University** — Ivy League pipeline
- **humanUPtions** — Workforce development, underserved populations

**Why it's hard to replicate:**

1. Trust takes years to build. Careerspan has V's 10+ years of career coaching credibility.
2. Communities can smell recruiters. The coaching-first model is genuine—the sourcing value is a byproduct.
...
### Tier 1: Strategic Fit (High)

**Handshake**

- *Why they'd care:* Campus recruiting is their core, but they only see students when they're actively job-hunting. Careerspan embeds earlier—coaching freshmen builds pipelines before they ever hit the job board. Plus: proven Emory/Columbia integrations are directly relevant.
- *The pitch:* "We're what Handshake becomes when it moves upstream—from job matching to talent development."
...
- *Why they'd care:* Talent CRM and pipeline building is their core. Careerspan's story-based profiles are a massive upgrade over traditional CRM data. And the community embedding model feeds pipelines they can't fill otherwise.
- *The pitch:* "We make your CRM data actually useful, and we fill it from communities you can't access."
...
- *Why they'd care:* Talent experience platform—employer branding, career sites, internal mobility. Careerspan's coaching model + community embedding = better candidate experience + proprietary pipelines.
- *The pitch:* "Talent experience that starts before the job search."

### Tier 3: Recruiting Industry Buyers
...
- *Why they'd care:* High-touch, relationship-driven—which is exactly what Careerspan's coaching model is. Executive-level adaptation of the platform could feed executive search pipelines.
- *The pitch:* "What if your relationship with candidates started before they were candidates?"
...
### Partnerships (Community Embedding Works)

- **Marvin Ventures** — Official sourcing partner for McKinsey's alumni-run venture fund
- Peace Corps (national program, 7K+ returnees/year)
- Emory University (elite institution, career services integration)
- Columbia University (Ivy League)
- humanUPtions (workforce development)

### Metrics (UX Cracked, Engagement Proven)
