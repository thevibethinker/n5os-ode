...
status: canonical
---
# Meeting Follow-Up Generation [MG-5]
...
After MG-5 completes, you may want to run **MG-6** to transition meetings to processed state:

> **Run next stage?** `@Meeting State Transition`
>
> MG-6 transitions meetings from 'intelligence_generated' to 'processed' and syncs stakeholder data to CRM.
