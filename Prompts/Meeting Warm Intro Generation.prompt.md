---
title: Meeting Warm Intro Generation
description: |
...
# Meeting Warm Intro Generation [MG-4]
...
After MG-4 completes, you may want to run **MG-5** to generate follow-up emails:

> **Run next stage?** `@Meeting Follow-Up Generation`
>
> MG-5 generates follow-up emails for meetings that have completed intelligence generation.
