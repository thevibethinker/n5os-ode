...
**Purpose:** Extract user problems, solution sketches, MVP scope, and validation approaches for Careerspan features.
...
### What This Lens Sees
R05 captures **product thinking** for Careerspan:
...
- **Non-Careerspan product ideas** → R08 (Venture Idea)
...
### Counter-Indicators
- Idea is for a business outside Careerspan
...
outreach tracker in Careerspan.
```
...
- [ ] User segment is in Careerspan's target
...
or feature thinking for Careerspan.
