...
**Purpose:** Extract business model sketches, market opportunities, and non-Careerspan business ideas.
...
### What This Lens Sees
R08 captures **venture thinking** outside Careerspan:
...
- **Careerspan feature ideas** → R05 (Product Idea)
- **Market analysis for Careerspan** → R04 (Market Signal)
- **Strategic Careerspan decisions** → R03 (Strategic Thought)

### Boundary Cases
- If idea could be Careerspan feature: If clearly outside scope → here; if adjacent → R05
...
### Dimension 3: Why Not Careerspan
| Reason | Implication |
|--------|-------------|
...
**Why Not Careerspan:** [Brief reason]
...
Careerspan — different buyer, different use case. But someone should
...
**Why Not Careerspan:** Different buyer (HR for ex-employees), different use case
...
**Blocking factors:** Focused on Careerspan
...
- [ ] Clearly NOT a Careerspan feature
- [ ] Why Not Careerspan is explicit
