...
|-----------|-------|----------|
| The owner introduces them to → | [N] | [High/Med/Low] |
| They introduce the owner to → | [N] | [High/Med/Low] |

---

## Section 1: Introductions the Owner Will Make
...
| Field | Value |
|-------|-------|
| **Target** | [Who the owner will be introduced to] |
| **Organization** | [Company/Role] |
