---
tool: true
description: "Generates intelligence blocks (B01-B35) for meetings in [M] state that lack them."
...
> **Run next stage?** `@Meeting Communications Generation`
>
> MG-3 generates follow-up emails, blurbs, and warm intro drafts based on the intelligence blocks created here.
