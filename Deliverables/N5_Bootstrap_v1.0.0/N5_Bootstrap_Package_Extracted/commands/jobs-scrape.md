...
- --output : file (optional) — Output file path (default: [COMPANY]/Jobs/scraped_YYYYMMDD.jsonl)
...
- Custom output: `python N5/scripts/jobs_scrape.py companies.txt --output [COMPANY]/Jobs/custom_scrape.jsonl`
...
**Lists**: `[COMPANY]/Jobs/opportunities.jsonl`
