...
<deepResearchPrompt v0.3-rc>
  ...
  <audience>[COMPANY] founders & strategy team</audience>
  ...
  <goal>
    ...
    that is immediately actionable for [COMPANY]’s partnership,
  ...
  <preExecution>
    1. Ask clarifying questions **only if**:
       • The user has NOT stated why {TARGET_ENTITY} matters to [COMPANY], **or**
       • Critical scoping info is missing (e.g., entity type, focus on individuals).
    2. Example prompts:
       • “What’s [COMPANY] hoping to achieve with this org—partnership, customer, or investment intel?”
  ...
  <deliverableStructure>
    ...
    2. ## Executive Summary (≤ 500 words)
       • Key findings & explicit **[COMPANY] Relevance**
  ...
  <[COMPANY]Relevance>
    ...
    • Overlap or conflict with [COMPANY]’s 3-D talent-data thesis
