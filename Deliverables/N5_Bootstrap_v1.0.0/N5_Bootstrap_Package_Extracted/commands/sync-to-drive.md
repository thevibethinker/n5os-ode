---
description: Sync [COMPANY]/Vrijen knowledge to Google Drive for external AI consumption (Zapier, etc.)
tags: [sync, drive, knowledge, external, automation]
---

# Sync Knowledge to Google Drive

Sync all [COMPANY] and Vrijen-related knowledge files to Google Drive for use with external AI tools (Zapier, Make, etc.).

## What It Does

Syncs the following knowledge to a "[COMPANY] Knowledge Sync" folder on Google Drive:
...
**Version:** 1.0  
**Created:** 2025-10-16  
**Drive Folder:** [[COMPANY] Knowledge Sync](https://drive.google.com/drive/folders/1xCg5XPFScVoneqZK0GRvURkzvKFV0AcW)
