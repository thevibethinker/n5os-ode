This file provides guidance when working with code in this repository. The README.md should ALWAYS serve as an accurate, comprehensive piece of documentation for this project. It should describe the broader goals and purpose of this repository along with the technical implementation details.

# Project Notes

<!-- Document how to operate any new structural components that have been added beyond the original template, key technical decisions, user preferences, and important takeaways from debugging sessions. -->

---

# Documentation

<!-- This documentation below should be preserved in its original form as a reference for the structure and capabilities of the original project template. -->
