...
- **Brief:** `file 'N5/orchestration/crm-v3-unified/WORKER_1_DATABASE_SCHEMA.md'`
...
- **Brief:** `file 'N5/orchestration/crm-v3-unified/WORKER_2_MIGRATION_SCRIPTS.md'`
...
- **Brief:** `file 'N5/orchestration/crm-v3-unified/WORKER_3_ENRICHMENT_WORKER.md'`
...
- **Brief:** `file 'N5/orchestration/crm-v3-unified/WORKER_4_CALENDAR_WEBHOOK.md'`
...
- **Brief:** `file 'N5/orchestration/crm-v3-unified/WORKER_4B_CALENDAR_PATCHES.md'`
...
bash /home/workspace/N5/orchestration/crm-v3-unified/integration_test.sh
```
