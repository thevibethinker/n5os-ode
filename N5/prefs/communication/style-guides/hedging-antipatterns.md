...
**Related files:**
- `file 'N5/prefs/communication/style-guides/succinctness-pairs.md'` — Before/after examples
- `file 'N5/prefs/communication/style-guides/directness-calibration.md'` — Context-appropriate directness
...
**Validation script:** `python3 N5/scripts/hedging_check.py`
