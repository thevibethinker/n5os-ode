...
**CRITICAL:** Before ANY workflow-related operation, check for registered prompts in `file 'N5/data/executables.db'` OR search `Prompts/**/*.md` for relevant protocols.
...
**Priority order:**
1. Recipe in Prompts/
2. Protocol documentation in Prompts/
...
- **Thread exports:** When user requests "export this thread" or similar, ALWAYS use `recipe 'Prompts/Productivity/Thread Export.md'`
...
- **System operations:** Check `Prompts/` for established workflows before manual implementation
- **Reflections:** Subject "reflection-ingest" or "[Reflect]" → See "Reflection Processing" section below
- **Content workflows:** Always search Prompts/ before creating ad-hoc processes
...
1. STOP and load `file 'Prompts/Meetings/Transcript Ingest.md'`
