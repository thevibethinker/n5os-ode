...
# Build: V's Prompt & Skill Store (Gumroad-style)
...
```bash
python3 N5/scripts/build_lesson_ledger.py read store-v1
```
...
- **PLAN.md:** `N5/builds/store-v1/PLAN.md`
- **Worker Briefs:** `N5/builds/store-v1/workers/`
- **Completions:** `N5/builds/store-v1/completions/`
- **meta.json:** `N5/builds/store-v1/meta.json`
