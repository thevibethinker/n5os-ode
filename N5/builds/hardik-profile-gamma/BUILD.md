...
# Build: Hardik Candidate Profile Gamma Site
...
```bash
python3 N5/scripts/build_lesson_ledger.py read hardik-profile-gamma
```
...
- **PLAN.md:** `N5/builds/hardik-profile-gamma/PLAN.md`
- **Worker Briefs:** `N5/builds/hardik-profile-gamma/workers/`
- **Completions:** `N5/builds/hardik-profile-gamma/completions/`
- **meta.json:** `N5/builds/hardik-profile-gamma/meta.json`
