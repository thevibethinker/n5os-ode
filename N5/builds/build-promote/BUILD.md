...
```bash
python3 N5/scripts/build_lesson_ledger.py read build-promote
```
...
- **PLAN.md:** `N5/builds/build-promote/PLAN.md`
- **Worker Briefs:** `N5/builds/build-promote/workers/`
- **Completions:** `N5/builds/build-promote/completions/`
- **meta.json:** `N5/builds/build-promote/meta.json`
