...
# Build: Moltbook Modularization + Performance Recovery

**Slug:** `moltbook-modularization`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read moltbook-modularization
```
...
- **PLAN.md:** `N5/builds/moltbook-modularization/PLAN.md`
- **Worker Briefs:** `N5/builds/moltbook-modularization/workers/`
- **Completions:** `N5/builds/moltbook-modularization/completions/`
- **meta.json:** `N5/builds/moltbook-modularization/meta.json`
