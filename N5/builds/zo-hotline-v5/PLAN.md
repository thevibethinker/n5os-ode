...
# Plan: Zoseph V5: Post-call email & tools
...
Run validator: python3 N5/scripts/mece_validator.py zo-hotline-v5
-->
...
- [ ] `python3 N5/scripts/mece_validator.py zo-hotline-v5` passes
