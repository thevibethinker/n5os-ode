...
# Build: Zoseph V5: Post-call email & tools
...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-hotline-v5
```
...
- **PLAN.md:** `N5/builds/zo-hotline-v5/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-hotline-v5/workers/`
- **Completions:** `N5/builds/zo-hotline-v5/completions/`
- **meta.json:** `N5/builds/zo-hotline-v5/meta.json`
