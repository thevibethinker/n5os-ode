...
build_slug: zo-hotline-v5
---

# Build Status: Zoseph V5: Post-call email & tools
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/zo-hotline-v5/PLAN.md` |
...
- `N5/builds/zo-hotline-v5/PLAN.md` - Build plan
- `N5/builds/zo-hotline-v5/STATUS.md` - This file
