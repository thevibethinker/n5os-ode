...
# Build: Agent Conflict Gate System

**Slug:** `agent-conflict-gate`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read agent-conflict-gate
```
...
- **PLAN.md:** `N5/builds/agent-conflict-gate/PLAN.md`
- **Worker Briefs:** `N5/builds/agent-conflict-gate/workers/`
- **Completions:** `N5/builds/agent-conflict-gate/completions/`
- **meta.json:** `N5/builds/agent-conflict-gate/meta.json`
