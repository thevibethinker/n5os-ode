...
# Build: Rice Integration — Routing, Installer, End-to-End Wiring

**Slug:** `rice-integration`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read rice-integration
```
...
- **PLAN.md:** `N5/builds/rice-integration/PLAN.md`
- **Worker Briefs:** `N5/builds/rice-integration/workers/`
- **Completions:** `N5/builds/rice-integration/completions/`
- **meta.json:** `N5/builds/rice-integration/meta.json`
