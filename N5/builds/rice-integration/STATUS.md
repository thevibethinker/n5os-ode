...
build_slug: rice-integration
---

# Build Status: Rice Integration — Routing, Installer, End-to-End Wiring
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/rice-integration/PLAN.md` |
...
- `N5/builds/rice-integration/PLAN.md` - Build plan
- `N5/builds/rice-integration/STATUS.md` - This file
