...
```bash
python3 N5/scripts/build_lesson_ledger.py read zode-moltbook
```
...
- **PLAN.md:** `N5/builds/zode-moltbook/PLAN.md`
- **Worker Briefs:** `N5/builds/zode-moltbook/workers/`
- **Completions:** `N5/builds/zode-moltbook/completions/`
- **meta.json:** `N5/builds/zode-moltbook/meta.json`
