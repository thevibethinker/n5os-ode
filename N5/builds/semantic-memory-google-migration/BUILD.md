...
# Build: Semantic Memory Google Migration

**Slug:** `semantic-memory-google-migration`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read semantic-memory-google-migration
```
...
- **PLAN.md:** `N5/builds/semantic-memory-google-migration/PLAN.md`
- **Worker Briefs:** `N5/builds/semantic-memory-google-migration/workers/`
- **Completions:** `N5/builds/semantic-memory-google-migration/completions/`
- **meta.json:** `N5/builds/semantic-memory-google-migration/meta.json`
