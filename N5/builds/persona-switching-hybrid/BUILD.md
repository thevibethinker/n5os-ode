...
# Build: Hybrid Persona Switching System

**Slug:** `persona-switching-hybrid`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read persona-switching-hybrid
```
...
- **PLAN.md:** `N5/builds/persona-switching-hybrid/PLAN.md`
- **Worker Briefs:** `N5/builds/persona-switching-hybrid/workers/`
- **Completions:** `N5/builds/persona-switching-hybrid/completions/`
- **meta.json:** `N5/builds/persona-switching-hybrid/meta.json`
