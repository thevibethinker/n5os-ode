...
# Build: Task System Validation & Backfill

**Slug:** `task-system-validation`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read task-system-validation
```
...
- **PLAN.md:** `N5/builds/task-system-validation/PLAN.md`
- **Worker Briefs:** `N5/builds/task-system-validation/workers/`
- **Completions:** `N5/builds/task-system-validation/completions/`
- **meta.json:** `N5/builds/task-system-validation/meta.json`
