...
```bash
python3 N5/scripts/build_lesson_ledger.py read ode-v2-upgrade
```
...
- **PLAN.md:** `N5/builds/ode-v2-upgrade/PLAN.md`
- **Worker Briefs:** `N5/builds/ode-v2-upgrade/workers/`
- **Completions:** `N5/builds/ode-v2-upgrade/completions/`
- **meta.json:** `N5/builds/ode-v2-upgrade/meta.json`
