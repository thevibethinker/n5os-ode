...
# Build: Port Conflict Detector

**Slug:** `port-conflict-detector`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read port-conflict-detector
```
...
- **PLAN.md:** `N5/builds/port-conflict-detector/PLAN.md`
- **Worker Briefs:** `N5/builds/port-conflict-detector/workers/`
- **Completions:** `N5/builds/port-conflict-detector/completions/`
- **meta.json:** `N5/builds/port-conflict-detector/meta.json`
