...
build_slug: port-conflict-detector
---

# Build Status: Port Conflict Detector
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/port-conflict-detector/PLAN.md` |
...
- `N5/builds/port-conflict-detector/PLAN.md` - Build plan
- `N5/builds/port-conflict-detector/STATUS.md` - This file
