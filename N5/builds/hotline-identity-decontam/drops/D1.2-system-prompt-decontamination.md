...
# D1.2: System prompt decontamination
...
```
python3 Skills/pulse/scripts/pulse_cc.py deposit hotline-identity-decontam D1.2 --status complete --summary "What was done"
```
