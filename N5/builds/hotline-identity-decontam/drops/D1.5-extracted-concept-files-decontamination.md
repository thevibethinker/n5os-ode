...
# D1.5: Extracted concept files decontamination
...
```
python3 Skills/pulse/scripts/pulse_cc.py deposit hotline-identity-decontam D1.5 --status complete --summary "What was done"
```
