...
# D1.3: Value prop tree decontamination
...
```
python3 Skills/pulse/scripts/pulse_cc.py deposit hotline-identity-decontam D1.3 --status complete --summary "What was done"
```
