...
# Build: Memory as Reasoning: Semantic Memory System Upgrade

**Slug:** `memory-as-reasoning`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read memory-as-reasoning
```
...
- **PLAN.md:** `N5/builds/memory-as-reasoning/PLAN.md`
- **Worker Briefs:** `N5/builds/memory-as-reasoning/workers/`
- **Completions:** `N5/builds/memory-as-reasoning/completions/`
- **meta.json:** `N5/builds/memory-as-reasoning/meta.json`
