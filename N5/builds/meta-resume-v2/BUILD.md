...
# Build: Meta Resume Generator v2: Schema Alignment + Design Evolution
...
```bash
python3 N5/scripts/build_lesson_ledger.py read meta-resume-v2
```
...
- **PLAN.md:** `N5/builds/meta-resume-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/meta-resume-v2/workers/`
- **Completions:** `N5/builds/meta-resume-v2/completions/`
- **meta.json:** `N5/builds/meta-resume-v2/meta.json`
