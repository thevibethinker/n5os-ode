---
worker_id: W1.4
title: "[ode-ux-hardening] W1.4: Task 4"
build_slug: ode-ux-hardening
wave: 1
depends_on: []
thread_title: "[ode-ux-hardening] W1.4: Task 4"
...
```bash
python3 N5/scripts/build_lesson_ledger.py append ode-ux-hardening "Your lesson here" --source W1.4
```
...
- [ ] If yes: `python3 N5/scripts/build_lesson_ledger.py append ode-ux-hardening "..." --source W1.4`
...
**DO NOT COMMIT.** Write completion to `N5/builds/ode-ux-hardening/completions/W1.4.json`
