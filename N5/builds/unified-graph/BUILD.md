...
# Build: Unified Knowledge Graph System
...
```bash
python3 N5/scripts/build_lesson_ledger.py read unified-graph
```
...
- **PLAN.md:** `N5/builds/unified-graph/PLAN.md`
- **Worker Briefs:** `N5/builds/unified-graph/workers/`
- **Completions:** `N5/builds/unified-graph/completions/`
- **meta.json:** `N5/builds/unified-graph/meta.json`
