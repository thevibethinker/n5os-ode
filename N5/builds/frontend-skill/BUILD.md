...
# Build: Frontend Design Skill for Landing Pages
...
```bash
python3 N5/scripts/build_lesson_ledger.py read frontend-skill
```
...
- **PLAN.md:** `N5/builds/frontend-skill/PLAN.md`
- **Worker Briefs:** `N5/builds/frontend-skill/workers/`
- **Completions:** `N5/builds/frontend-skill/completions/`
- **meta.json:** `N5/builds/frontend-skill/meta.json`
