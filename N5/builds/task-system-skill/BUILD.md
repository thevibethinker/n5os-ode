...
# Build: Task System Skill Restructure

**Slug:** `task-system-skill`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read task-system-skill
```
...
- **PLAN.md:** `N5/builds/task-system-skill/PLAN.md`
- **Worker Briefs:** `N5/builds/task-system-skill/workers/`
- **Completions:** `N5/builds/task-system-skill/completions/`
- **meta.json:** `N5/builds/task-system-skill/meta.json`
