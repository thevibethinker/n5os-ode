...
# Build: WorkOS Authentication Integration
...
```bash
python3 N5/scripts/build_lesson_ledger.py read workos-integration
```
...
- **PLAN.md:** `N5/builds/workos-integration/PLAN.md`
- **Worker Briefs:** `N5/builds/workos-integration/workers/`
- **Completions:** `N5/builds/workos-integration/completions/`
- **meta.json:** `N5/builds/workos-integration/meta.json`
