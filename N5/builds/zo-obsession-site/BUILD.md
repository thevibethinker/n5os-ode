...
# Build: Zo Obsession Site

**Slug:** `zo-obsession-site`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-obsession-site
```
...
- **PLAN.md:** `N5/builds/zo-obsession-site/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-obsession-site/workers/`
- **Completions:** `N5/builds/zo-obsession-site/completions/`
- **meta.json:** `N5/builds/zo-obsession-site/meta.json`
