...
# Build: Careerspan Founder Scan Management Integration

**Slug:** `careerspan-scan-mgmt`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read careerspan-scan-mgmt
```
...
- **PLAN.md:** `N5/builds/careerspan-scan-mgmt/PLAN.md`
- **Worker Briefs:** `N5/builds/careerspan-scan-mgmt/workers/`
- **Completions:** `N5/builds/careerspan-scan-mgmt/completions/`
- **meta.json:** `N5/builds/careerspan-scan-mgmt/meta.json`
