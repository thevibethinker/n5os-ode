...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-task-system
```
...
- **PLAN.md:** `N5/builds/zo-task-system/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-task-system/workers/`
- **Completions:** `N5/builds/zo-task-system/completions/`
- **meta.json:** `N5/builds/zo-task-system/meta.json`
