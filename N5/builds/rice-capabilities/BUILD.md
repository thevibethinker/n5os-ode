...
# Build: Rice Capabilities — The 8 Infrastructure Modules

**Slug:** `rice-capabilities`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read rice-capabilities
```
...
- **PLAN.md:** `N5/builds/rice-capabilities/PLAN.md`
- **Worker Briefs:** `N5/builds/rice-capabilities/workers/`
- **Completions:** `N5/builds/rice-capabilities/completions/`
- **meta.json:** `N5/builds/rice-capabilities/meta.json`
