...
```bash
python3 N5/scripts/build_lesson_ledger.py read zoputer-autonomy-v2
```
...
- **PLAN.md:** `N5/builds/zoputer-autonomy-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/zoputer-autonomy-v2/workers/`
- **Completions:** `N5/builds/zoputer-autonomy-v2/completions/`
- **meta.json:** `N5/builds/zoputer-autonomy-v2/meta.json`
