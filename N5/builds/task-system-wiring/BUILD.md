...
# Build: Task System Wiring - Meeting & Close Integration

**Slug:** `task-system-wiring`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read task-system-wiring
```
...
- **PLAN.md:** `N5/builds/task-system-wiring/PLAN.md`
- **Worker Briefs:** `N5/builds/task-system-wiring/workers/`
- **Completions:** `N5/builds/task-system-wiring/completions/`
- **meta.json:** `N5/builds/task-system-wiring/meta.json`
