...
# Build: Careerspan Job Sourcing Pipeline

**Slug:** `cs-job-pipeline`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read cs-job-pipeline
```
...
- **PLAN.md:** `N5/builds/cs-job-pipeline/PLAN.md`
- **Worker Briefs:** `N5/builds/cs-job-pipeline/workers/`
- **Completions:** `N5/builds/cs-job-pipeline/completions/`
- **meta.json:** `N5/builds/cs-job-pipeline/meta.json`
