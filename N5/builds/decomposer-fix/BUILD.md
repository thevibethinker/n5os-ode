...
```bash
python3 N5/scripts/build_lesson_ledger.py read decomposer-fix
```
...
- **PLAN.md:** `N5/builds/decomposer-fix/PLAN.md`
- **Worker Briefs:** `N5/builds/decomposer-fix/workers/`
- **Completions:** `N5/builds/decomposer-fix/completions/`
- **meta.json:** `N5/builds/decomposer-fix/meta.json`
