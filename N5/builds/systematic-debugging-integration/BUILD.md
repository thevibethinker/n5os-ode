...
# Build: Systematic Debugging Integration

**Slug:** `systematic-debugging-integration`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read systematic-debugging-integration
```
...
- **PLAN.md:** `N5/builds/systematic-debugging-integration/PLAN.md`
- **Worker Briefs:** `N5/builds/systematic-debugging-integration/workers/`
- **Completions:** `N5/builds/systematic-debugging-integration/completions/`
- **meta.json:** `N5/builds/systematic-debugging-integration/meta.json`
