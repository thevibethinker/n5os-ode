...
build_slug: emily-velasco-intel
---

# Build Status: Meeting Intelligence Blocks: Emily Velasco
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/emily-velasco-intel/PLAN.md` |
...
- `N5/builds/emily-velasco-intel/PLAN.md` - Build plan
- `N5/builds/emily-velasco-intel/STATUS.md` - This file
