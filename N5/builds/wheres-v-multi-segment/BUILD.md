...
# Build: Where's V: Multi-Segment Trip Support

**Slug:** `wheres-v-multi-segment`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read wheres-v-multi-segment
```
...
- **PLAN.md:** `N5/builds/wheres-v-multi-segment/PLAN.md`
- **Worker Briefs:** `N5/builds/wheres-v-multi-segment/workers/`
- **Completions:** `N5/builds/wheres-v-multi-segment/completions/`
- **meta.json:** `N5/builds/wheres-v-multi-segment/meta.json`
