...
# Build: Zo Hotline - Voice Support System
...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-hotline
```
...
- **PLAN.md:** `N5/builds/zo-hotline/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-hotline/workers/`
- **Completions:** `N5/builds/zo-hotline/completions/`
- **meta.json:** `N5/builds/zo-hotline/meta.json`
