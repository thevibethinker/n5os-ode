...
build_slug: notion-deals-sync
---

# Build Status: Notion ↔ Deals Sync via Pipedream
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/notion-deals-sync/PLAN.md` |
...
- `N5/builds/notion-deals-sync/PLAN.md` - Build plan
- `N5/builds/notion-deals-sync/STATUS.md` - This file
