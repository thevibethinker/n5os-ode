...
# Build: N5OS Ode Version Cleanup & Sync Hardening
...
```bash
python3 N5/scripts/build_lesson_ledger.py read ode-cleanup
```
...
- **PLAN.md:** `N5/builds/ode-cleanup/PLAN.md`
- **Worker Briefs:** `N5/builds/ode-cleanup/workers/`
- **Completions:** `N5/builds/ode-cleanup/completions/`
- **meta.json:** `N5/builds/ode-cleanup/meta.json`
