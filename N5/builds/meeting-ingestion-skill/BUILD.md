...
# Build: Complete Meeting Ingestion Skill

**Slug:** `meeting-ingestion-skill`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read meeting-ingestion-skill
```
...
- **PLAN.md:** `N5/builds/meeting-ingestion-skill/PLAN.md`
- **Worker Briefs:** `N5/builds/meeting-ingestion-skill/workers/`
- **Completions:** `N5/builds/meeting-ingestion-skill/completions/`
- **meta.json:** `N5/builds/meeting-ingestion-skill/meta.json`
