...
- **PLAN.md:** `N5/builds/sms-event-concierge-v1/PLAN.md`
- **Worker Briefs:** `N5/builds/sms-event-concierge-v1/workers/`
- **Completions:** `N5/builds/sms-event-concierge-v1/completions/`
- **meta.json:** `N5/builds/sms-event-concierge-v1/meta.json`
