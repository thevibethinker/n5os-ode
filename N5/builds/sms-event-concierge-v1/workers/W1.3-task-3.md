---
worker_id: W1.3
title: "[sms-event-concierge-v1] W1.3: Task 3"
build_slug: sms-event-concierge-v1
wave: 1
depends_on: []
thread_title: "[sms-event-concierge-v1] W1.3: Task 3"
...
```bash
python3 N5/scripts/validate_worker_launch.py sms-event-concierge-v1 W1.3
```
...
```bash
python3 N5/scripts/validate_worker_launch.py sms-event-concierge-v1 W1.3 --force
```
...
```bash
python3 N5/scripts/build_lesson_ledger.py append sms-event-concierge-v1 "Your lesson here" --source W1.3
```
...
- [ ] If yes: `python3 N5/scripts/build_lesson_ledger.py append sms-event-concierge-v1 "..." --source W1.3`
...
**DO NOT COMMIT.** Write completion to `N5/builds/sms-event-concierge-v1/completions/W1.3.json`
