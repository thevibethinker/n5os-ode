...
Run validator: python3 N5/scripts/mece_validator.py sms-event-concierge-v1
-->
...
- [ ] `python3 N5/scripts/mece_validator.py sms-event-concierge-v1` passes
