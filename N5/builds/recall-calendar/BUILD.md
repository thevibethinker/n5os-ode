...
# Build: Recall.ai Calendar Integration

**Slug:** `recall-calendar`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read recall-calendar
```
...
- **PLAN.md:** `N5/builds/recall-calendar/PLAN.md`
- **Worker Briefs:** `N5/builds/recall-calendar/workers/`
- **Completions:** `N5/builds/recall-calendar/completions/`
- **meta.json:** `N5/builds/recall-calendar/meta.json`
