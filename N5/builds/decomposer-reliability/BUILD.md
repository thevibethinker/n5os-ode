...
# Build: Careerspan Decomposer Reliability

**Slug:** `decomposer-reliability`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read decomposer-reliability
```
...
- **PLAN.md:** `N5/builds/decomposer-reliability/PLAN.md`
- **Worker Briefs:** `N5/builds/decomposer-reliability/workers/`
- **Completions:** `N5/builds/decomposer-reliability/completions/`
- **meta.json:** `N5/builds/decomposer-reliability/meta.json`
