...
# Build: Builds Audit Cleanup

**Slug:** `builds-audit-cleanup`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read builds-audit-cleanup
```
...
- **PLAN.md:** `N5/builds/builds-audit-cleanup/PLAN.md`
- **Worker Briefs:** `N5/builds/builds-audit-cleanup/workers/`
- **Completions:** `N5/builds/builds-audit-cleanup/completions/`
- **meta.json:** `N5/builds/builds-audit-cleanup/meta.json`
