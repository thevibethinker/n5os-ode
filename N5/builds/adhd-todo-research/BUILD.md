...
# Build: ADHD-Optimized Task System Research

**Slug:** `adhd-todo-research`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read adhd-todo-research
```
...
- **PLAN.md:** `N5/builds/adhd-todo-research/PLAN.md`
- **Worker Briefs:** `N5/builds/adhd-todo-research/workers/`
- **Completions:** `N5/builds/adhd-todo-research/completions/`
- **meta.json:** `N5/builds/adhd-todo-research/meta.json`
