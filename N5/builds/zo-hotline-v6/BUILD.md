...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-hotline-v6
```
...
- **PLAN.md:** `N5/builds/zo-hotline-v6/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-hotline-v6/workers/`
- **Completions:** `N5/builds/zo-hotline-v6/completions/`
- **meta.json:** `N5/builds/zo-hotline-v6/meta.json`
