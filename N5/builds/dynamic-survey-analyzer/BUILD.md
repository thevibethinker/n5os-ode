...
# Build: Dynamic Survey Analyzer Skill

**Slug:** `dynamic-survey-analyzer`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read dynamic-survey-analyzer
```
...
- **PLAN.md:** `N5/builds/dynamic-survey-analyzer/PLAN.md`
- **Worker Briefs:** `N5/builds/dynamic-survey-analyzer/workers/`
- **Completions:** `N5/builds/dynamic-survey-analyzer/completions/`
- **meta.json:** `N5/builds/dynamic-survey-analyzer/meta.json`
