...
# Build: B05 Consolidation & Semantic Backfill
...
```bash
python3 N5/scripts/build_lesson_ledger.py read b05-backfill
```
...
- **PLAN.md:** `N5/builds/b05-backfill/PLAN.md`
- **Worker Briefs:** `N5/builds/b05-backfill/workers/`
- **Completions:** `N5/builds/b05-backfill/completions/`
- **meta.json:** `N5/builds/b05-backfill/meta.json`
