...
# Build: Concept Graph Experiment: Heterogeneous Node Architecture

**Slug:** `concept-graph-experiment`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read concept-graph-experiment
```
...
- **PLAN.md:** `N5/builds/concept-graph-experiment/PLAN.md`
- **Worker Briefs:** `N5/builds/concept-graph-experiment/workers/`
- **Completions:** `N5/builds/concept-graph-experiment/completions/`
- **meta.json:** `N5/builds/concept-graph-experiment/meta.json`
