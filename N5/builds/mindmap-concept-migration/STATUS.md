...
# Build Status: Mind Map: Migrate to Heterogeneous Concept Graph Architecture
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/mindmap-concept-migration/PLAN.md` |
...
- `N5/builds/mindmap-concept-migration/PLAN.md` - Build plan
- `N5/builds/mindmap-concept-migration/STATUS.md` - This file
