...
# Build: Store Enhancements: Export Pipeline + UX
...
```bash
python3 N5/scripts/build_lesson_ledger.py read store-v2
```
...
- **PLAN.md:** `N5/builds/store-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/store-v2/workers/`
- **Completions:** `N5/builds/store-v2/completions/`
- **meta.json:** `N5/builds/store-v2/meta.json`
