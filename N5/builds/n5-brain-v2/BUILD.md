...
# Build: N5 Brain v2: FlashRank + GraphRAG + Temporal Tracking
...
```bash
python3 N5/scripts/build_lesson_ledger.py read n5-brain-v2
```
...
- **PLAN.md:** `N5/builds/n5-brain-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/n5-brain-v2/workers/`
- **Completions:** `N5/builds/n5-brain-v2/completions/`
- **meta.json:** `N5/builds/n5-brain-v2/meta.json`
