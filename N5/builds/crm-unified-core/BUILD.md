...
# Build: Crm Unified Core

**Slug:** `crm-unified-core`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read crm-unified-core
```
...
- **PLAN.md:** `N5/builds/crm-unified-core/PLAN.md`
- **Worker Briefs:** `N5/builds/crm-unified-core/workers/`
- **Completions:** `N5/builds/crm-unified-core/completions/`
- **meta.json:** `N5/builds/crm-unified-core/meta.json`
