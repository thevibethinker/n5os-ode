...
# Build: Performance Intelligence Dashboard v2

**Slug:** `perf-dashboard-v2`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read perf-dashboard-v2
```
...
- **PLAN.md:** `N5/builds/perf-dashboard-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/perf-dashboard-v2/workers/`
- **Completions:** `N5/builds/perf-dashboard-v2/completions/`
- **meta.json:** `N5/builds/perf-dashboard-v2/meta.json`
