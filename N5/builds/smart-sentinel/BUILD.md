...
# Build: Smart Sentinel: Recovery Engine for Pulse
...
```bash
python3 N5/scripts/build_lesson_ledger.py read smart-sentinel
```
...
- **PLAN.md:** `N5/builds/smart-sentinel/PLAN.md`
- **Worker Briefs:** `N5/builds/smart-sentinel/workers/`
- **Completions:** `N5/builds/smart-sentinel/completions/`
- **meta.json:** `N5/builds/smart-sentinel/meta.json`
