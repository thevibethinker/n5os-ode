...
# Build: Even Realities G2 & R1 Ring Combo Guide

**Slug:** `even-realities-g2-guide`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read even-realities-g2-guide
```
...
- **PLAN.md:** `N5/builds/even-realities-g2-guide/PLAN.md`
- **Worker Briefs:** `N5/builds/even-realities-g2-guide/workers/`
- **Completions:** `N5/builds/even-realities-g2-guide/completions/`
- **meta.json:** `N5/builds/even-realities-g2-guide/meta.json`
