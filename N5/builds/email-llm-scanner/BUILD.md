...
# Build: LLM-Powered Email Deal Scanner

**Slug:** `email-llm-scanner`  
...
- **PLAN.md:** `N5/builds/email-llm-scanner/PLAN.md`
- **Worker Briefs:** `N5/builds/email-llm-scanner/workers/`
- **Completions:** `N5/builds/email-llm-scanner/completions/`
- **meta.json:** `N5/builds/email-llm-scanner/meta.json`
