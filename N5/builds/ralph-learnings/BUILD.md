...
# Build: Ralph Learnings Implementation

**Slug:** `ralph-learnings`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read ralph-learnings
```
...
- **PLAN.md:** `N5/builds/ralph-learnings/PLAN.md`
- **Worker Briefs:** `N5/builds/ralph-learnings/workers/`
- **Completions:** `N5/builds/ralph-learnings/completions/`
- **meta.json:** `N5/builds/ralph-learnings/meta.json`
