...
# Build: Careerspan Pipeline V2

**Slug:** `careerspan-pipeline-v2`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read careerspan-pipeline-v2
```
...
- **PLAN.md:** `N5/builds/careerspan-pipeline-v2/PLAN.md`
- **Worker Briefs:** `N5/builds/careerspan-pipeline-v2/workers/`
- **Completions:** `N5/builds/careerspan-pipeline-v2/completions/`
- **meta.json:** `N5/builds/careerspan-pipeline-v2/meta.json`
