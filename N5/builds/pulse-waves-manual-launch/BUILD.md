...
# Build: Pulse: Waves schema rename + manual-drop launcher + Sentinel check

**Slug:** `pulse-waves-manual-launch`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read pulse-waves-manual-launch
```
...
- **PLAN.md:** `N5/builds/pulse-waves-manual-launch/PLAN.md`
- **Worker Briefs:** `N5/builds/pulse-waves-manual-launch/workers/`
- **Completions:** `N5/builds/pulse-waves-manual-launch/completions/`
- **meta.json:** `N5/builds/pulse-waves-manual-launch/meta.json`
