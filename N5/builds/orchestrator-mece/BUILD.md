...
# Build: Build Orchestrator MECE Upgrade

**Slug:** `orchestrator-mece`  
...
- **PLAN.md:** `N5/builds/orchestrator-mece/PLAN.md`
- **Worker Briefs:** `N5/builds/orchestrator-mece/workers/`
- **Completions:** `N5/builds/orchestrator-mece/completions/`
- **meta.json:** `N5/builds/orchestrator-mece/meta.json`
