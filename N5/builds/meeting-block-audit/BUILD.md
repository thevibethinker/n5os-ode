...
# Build: Meeting Intelligence Block Quality Audit

**Slug:** `meeting-block-audit`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read meeting-block-audit
```
...
- **PLAN.md:** `N5/builds/meeting-block-audit/PLAN.md`
- **Worker Briefs:** `N5/builds/meeting-block-audit/workers/`
- **Completions:** `N5/builds/meeting-block-audit/completions/`
- **meta.json:** `N5/builds/meeting-block-audit/meta.json`
