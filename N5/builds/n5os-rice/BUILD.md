...
# Build: N5OS-Rice — Architecture & Strategy (Stream 1)
...
```bash
python3 N5/scripts/build_lesson_ledger.py read n5os-rice
```
...
- **PLAN.md:** `N5/builds/n5os-rice/PLAN.md`
- **Worker Briefs:** `N5/builds/n5os-rice/workers/`
- **Completions:** `N5/builds/n5os-rice/completions/`
- **meta.json:** `N5/builds/n5os-rice/meta.json`
