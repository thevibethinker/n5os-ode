...
# Build: Unified Knowledge Graph: Fix, Merge, Resume
...
```bash
python3 N5/scripts/build_lesson_ledger.py read graph-unify
```
...
- **PLAN.md:** `N5/builds/graph-unify/PLAN.md`
- **Worker Briefs:** `N5/builds/graph-unify/workers/`
- **Completions:** `N5/builds/graph-unify/completions/`
- **meta.json:** `N5/builds/graph-unify/meta.json`
