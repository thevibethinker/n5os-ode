...
# Build: Next Play Seminar Tactics Research

**Slug:** `seminar-tactics-research`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read seminar-tactics-research
```
...
- **PLAN.md:** `N5/builds/seminar-tactics-research/PLAN.md`
- **Worker Briefs:** `N5/builds/seminar-tactics-research/workers/`
- **Completions:** `N5/builds/seminar-tactics-research/completions/`
- **meta.json:** `N5/builds/seminar-tactics-research/meta.json`
