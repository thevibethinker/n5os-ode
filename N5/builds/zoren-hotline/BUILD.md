...
```bash
python3 N5/scripts/build_lesson_ledger.py read zoren-hotline
```
...
- **PLAN.md:** `N5/builds/zoren-hotline/PLAN.md`
- **Worker Briefs:** `N5/builds/zoren-hotline/workers/`
- **Completions:** `N5/builds/zoren-hotline/completions/`
- **meta.json:** `N5/builds/zoren-hotline/meta.json`
