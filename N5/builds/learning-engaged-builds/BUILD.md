...
# Build: Learning-Engaged Build Mode

**Slug:** `learning-engaged-builds`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read learning-engaged-builds
```
...
- **PLAN.md:** `N5/builds/learning-engaged-builds/PLAN.md`
- **Worker Briefs:** `N5/builds/learning-engaged-builds/workers/`
- **Completions:** `N5/builds/learning-engaged-builds/completions/`
- **meta.json:** `N5/builds/learning-engaged-builds/meta.json`
