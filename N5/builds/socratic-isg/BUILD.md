...
# Build: Socratic Information Sufficiency Gate
...
```bash
python3 N5/scripts/build_lesson_ledger.py read socratic-isg
```
...
- **PLAN.md:** `N5/builds/socratic-isg/PLAN.md`
- **Worker Briefs:** `N5/builds/socratic-isg/workers/`
- **Completions:** `N5/builds/socratic-isg/completions/`
- **meta.json:** `N5/builds/socratic-isg/meta.json`
