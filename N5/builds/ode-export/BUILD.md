...
```bash
python3 N5/scripts/build_lesson_ledger.py read ode-export
```
...
- **PLAN.md:** `N5/builds/ode-export/PLAN.md`
- **Worker Briefs:** `N5/builds/ode-export/workers/`
- **Completions:** `N5/builds/ode-export/completions/`
- **meta.json:** `N5/builds/ode-export/meta.json`
