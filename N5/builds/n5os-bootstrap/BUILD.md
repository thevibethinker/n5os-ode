...
```bash
python3 N5/scripts/build_lesson_ledger.py read n5os-bootstrap
```
...
- **PLAN.md:** `N5/builds/n5os-bootstrap/PLAN.md`
- **Worker Briefs:** `N5/builds/n5os-bootstrap/workers/`
- **Completions:** `N5/builds/n5os-bootstrap/completions/`
- **meta.json:** `N5/builds/n5os-bootstrap/meta.json`
