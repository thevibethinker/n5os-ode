...
# Build: Rice Core — Zoffice Skeleton & Config Schemas
...
```bash
python3 N5/scripts/build_lesson_ledger.py read rice-core
```
...
- **PLAN.md:** `N5/builds/rice-core/PLAN.md`
- **Worker Briefs:** `N5/builds/rice-core/workers/`
- **Completions:** `N5/builds/rice-core/completions/`
- **meta.json:** `N5/builds/rice-core/meta.json`
