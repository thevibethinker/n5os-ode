...
build_slug: rice-core
---

# Build Status: Rice Core — Zoffice Skeleton & Config Schemas
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/rice-core/PLAN.md` |
...
- `N5/builds/rice-core/PLAN.md` - Build plan
- `N5/builds/rice-core/STATUS.md` - This file
