...
# Build: Zo Hotline Knowledge Expansion

**Slug:** `zo-hotline-knowledge-expansion`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read zo-hotline-knowledge-expansion
```
...
- **PLAN.md:** `N5/builds/zo-hotline-knowledge-expansion/PLAN.md`
- **Worker Briefs:** `N5/builds/zo-hotline-knowledge-expansion/workers/`
- **Completions:** `N5/builds/zo-hotline-knowledge-expansion/completions/`
- **meta.json:** `N5/builds/zo-hotline-knowledge-expansion/meta.json`
