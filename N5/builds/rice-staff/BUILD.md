...
# Build: Rice Staff — Starter Employees (Receptionist, CoS, Librarian)
...
```bash
python3 N5/scripts/build_lesson_ledger.py read rice-staff
```
...
- **PLAN.md:** `N5/builds/rice-staff/PLAN.md`
- **Worker Briefs:** `N5/builds/rice-staff/workers/`
- **Completions:** `N5/builds/rice-staff/completions/`
- **meta.json:** `N5/builds/rice-staff/meta.json`
