...
build_slug: rice-staff
---

# Build Status: Rice Staff — Starter Employees (Receptionist, CoS, Librarian)
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/rice-staff/PLAN.md` |
...
- `N5/builds/rice-staff/PLAN.md` - Build plan
- `N5/builds/rice-staff/STATUS.md` - This file
