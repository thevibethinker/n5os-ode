...
- [ ] **Worker 1 – Schema & Scaffolding**
  - Brief: `N5/builds/capability-registry-v1/WORKER_1_schema_and_scaffolding.md`
  - Deliverables:
...
- [ ] **Worker 2 – Integrations Inventory**
  - Brief: `N5/builds/capability-registry-v1/WORKER_2_integrations_inventory.md`
...
- [ ] **Worker 3 – Internal Systems & Pipelines**
  - Brief: `N5/builds/capability-registry-v1/WORKER_3_internal_systems.md`
...
- [ ] **Worker 4 – Workflows, Agents, Orchestrators**
  - Brief: `N5/builds/capability-registry-v1/WORKER_4_workflows_and_agents.md`
  - Focus: N5 workflows (`N5/workflows/**`), scheduled tasks, orchestrator builds under `N5/builds/**`
  - Deliverables:
...
- [ ] **Worker 5 – Conversation-End Integration & QA**
  - Brief: `N5/builds/capability-registry-v1/WORKER_5_conversation_end_integration.md`
