...
# D1.2: Stripe Products + Payment Links
...
```
python3 Skills/pulse/scripts/pulse_cc.py deposit career-hotline-monetization D1.2 --status complete --summary "What was done"
```
