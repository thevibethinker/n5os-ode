...
# Build: Pulse Build Variants & Jettison Launch Mode
...
```bash
python3 N5/scripts/build_lesson_ledger.py read pulse-variants
```
...
- **PLAN.md:** `N5/builds/pulse-variants/PLAN.md`
- **Worker Briefs:** `N5/builds/pulse-variants/workers/`
- **Completions:** `N5/builds/pulse-variants/completions/`
- **meta.json:** `N5/builds/pulse-variants/meta.json`
