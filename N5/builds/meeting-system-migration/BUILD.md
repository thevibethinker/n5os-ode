...
# Build: Meeting System Migration + Agent Audit

**Slug:** `meeting-system-migration`  
...
```bash
python3 N5/scripts/build_lesson_ledger.py read meeting-system-migration
```
...
- **PLAN.md:** `N5/builds/meeting-system-migration/PLAN.md`
- **Worker Briefs:** `N5/builds/meeting-system-migration/workers/`
- **Completions:** `N5/builds/meeting-system-migration/completions/`
- **meta.json:** `N5/builds/meeting-system-migration/meta.json`
