---
description: |
  Review and manage generated drafts (emails, documents, etc.)
  stored in Records/Personal/drafts/. List pending drafts,
  clean up old drafts, and archive after action taken.
tags:
  - drafts
  - review
  - cleanup
