---
description: Generate multiple LinkedIn posts from source material, each exploring a distinct angle (one post per execution to preserve cognitive quality)
tags:
  - social
  - content
  - linkedin
...
- Reflection: `file N5/records/reflections/outputs/{date}_{topic}/detail.md` 
- Meeting: `file N5/records/meetings/{date}_{name}/B01_DETAILED_RECAP.md` 
- Digest: `file N5/digests/{type}-{date}.md` 
...
- `file N5/prefs/communication/voice.md`  — Tone dials, style patterns
...
`file Documents/Social/LinkedIn/{date}_{topic}_{angle-slug}_post.md` 
...
`file Documents/Social/LinkedIn/2025-10-20_zo-gtm_founder-pain_post.md
...
**Source:** `file N5/records/reflections/outputs/2025-10-20_zo-system-gtm/detail.md` 
...
**Output:** `file Documents/Social/LinkedIn/2025-10-20_zo-gtm_founder-pain_post.md` 
