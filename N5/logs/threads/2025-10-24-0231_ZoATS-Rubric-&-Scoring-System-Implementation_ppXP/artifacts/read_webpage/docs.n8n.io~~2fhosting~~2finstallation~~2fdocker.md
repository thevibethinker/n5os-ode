...
* [Using n8n](https://docs.n8n.io/)
  ...
  + Using the app
    ...
    - [Understand workflows](https://docs.n8n.io/workflows/)
      ...
      * [Sub-workflow conversion](https://docs.n8n.io/workflows/subworkflow-conversion/)
    ...
    - [Manage users and access](https://docs.n8n.io/user-management/)
      ...
      * [OIDC](https://docs.n8n.io/user-management/oidc/)

        OIDC
        + [Set up OIDC](https://docs.n8n.io/user-management/oidc/setup/)
        + [Troubleshooting](https://docs.n8n.io/user-management/oidc/troubleshooting/)
  ...
  + Enterprise features
    ...
    - [Source control and environments](https://docs.n8n.io/source-control-environments/)
      ...
      * [Using](https://docs.n8n.io/source-control-environments/using/)
        ...
        + [Compare workflow changes](https://docs.n8n.io/source-control-environments/using/compare-changes/)
...
* [Integrations](https://docs.n8n.io/integrations/)
  ...
  + Built-in nodes
    ...
    - [Core nodes](https://docs.n8n.io/integrations/builtin/core-nodes/)
      ...
      * [Respond to Chat](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.respondtochat/)
    ...
    - [Actions](https://docs.n8n.io/integrations/builtin/app-nodes/)
      ...
      * [Customer Datastore (n8n Training)](https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.n8
... (truncated)