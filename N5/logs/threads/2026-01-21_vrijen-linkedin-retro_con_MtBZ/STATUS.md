...
build_slug: linkedin-dashboard
---

# Build Status: LinkedIn Data Visualization Dashboard
...
| **Blocked?** | No |
| **Plan File** | `N5/builds/linkedin-dashboard/PLAN.md` |
...
- `N5/builds/linkedin-dashboard/PLAN.md` - Build plan
- `N5/builds/linkedin-dashboard/STATUS.md` - This file
