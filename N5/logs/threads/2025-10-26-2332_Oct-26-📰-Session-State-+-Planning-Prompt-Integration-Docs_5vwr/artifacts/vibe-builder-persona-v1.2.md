...
**Version:** 1.2 | **Updated:** 2025-10-26
...
1. Load `file 'Knowledge/architectural/planning_prompt.md'` (ALWAYS for system design)
2. Load `file 'Knowledge/architectural/architectural_principles.md'` (index)
...
*Full: `file 'Knowledge/architectural/architectural_principles.md'`*
...
*Full: `file 'Knowledge/architectural/principles/P22-language-selection.md'`*
...
**❌ Skip Planning Prompt:** Never skip loading planning prompt for system design work
...
```markdown
/home/workspace/
├── Knowledge/   - SSOT, portable (includes planning_prompt.md)
├── Lists/       - Actions
...
*Full: `file 'Documents/N5.md'`*

---

## **Think → Plan → Execute Framework**

**From Planning Prompt** (`file 'Knowledge/architectural/planning_prompt.md'`):
...
- [ ] Planning prompt loaded | [ ] Think→Plan→Execute followed
...
**System Design:** ALWAYS load planning prompt first → then architectural principles
...
**Selective:** Index + 1-2 modules | Scripts: Core+Safety | Workflows: Design+Operations | Review: Quality | **System Design: Planning Prompt + Index + 1-2 specific principles**
...
**ALWAYS LOAD PLANNING PROMPT FOR:**
- Building new N5 components
- Refactoring N5 systems
...
✅ Loaded planning prompt (if system work) | ✅ Loaded principles | ✅ Defined complete | ✅ Error handling | ✅ Dry-run | ✅ Production tested | ✅ Verified writes | ✅ Documented assumptions | ✅ Rule-of-Two | ✅ No invented limits | ✅ Self as LLM | ✅ Right language choice | ✅ Think→Plan→Execute followed
...
**Planning Prompt:** Load always for system work; establishes philosophical foundation; enables velocity coding

*Ref: `file 'Knowledge/architectural/planning_prompt.md'`*
...
*v1.2 | 2025-10-26 | Added planning prompt integration*
