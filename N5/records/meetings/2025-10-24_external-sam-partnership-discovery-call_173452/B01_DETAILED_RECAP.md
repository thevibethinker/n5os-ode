...
**Market positioning insight**: Both teams recognize the dual-sided marketplace is brutally hard. Careerspan initially tried to serve both candidates and employers but realizing sourcing focus makes more sense. Sam already owns founder network + employer relationships. Natural division of labor.

**Key differentiation**: Careerspan's retention numbers are exceptional (20-40% D30 return, 40%+ for users who get job recommendations). This is because the tool is genuinely pro-candidate (AI coaching that helps them reflect, not just another resume parser). Creates organic re-engagement loop that solves the "stale candidate data" problem plaguing recruiting.

**Competitive landscape signal**: Sam compared to Superposition (Edmund's company). Superposition exploring product-role focus initially, while Sam is role-agnostic. This suggests fragmentation in recruiting tech space - opportunities for specialized plays.

**Technical credibility**: Ash and team validated Careerspan's tech depth. Key differentiator is Ilsa's reliability engineering - not just "vibe-coded" LLM outputs but consistent JSON schemas, defensible AI assessments, robust bullshit detection. This matters given coming legal/compliance pressure on AI hiring tools.

**Team chemistry**: Strong vibe match between founders. Vrijen explicitly stated "would rather make less money and work with you guys 100 years" vs other acquisition conversations (e.g., ETS). This relationship capital reduces friction on deal structure.
