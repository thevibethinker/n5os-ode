---
description: |
  Add new social media post to content library.
  
  Imports post content, generates metadata, assigns to platform/status folder.
  Supports dry-run and auto-extraction of title from content.
tags:
  - social-media
  - content
  - linkedin
