...
Automatically updates commands.md from commands.jsonl with authored command examples.
...
class CommandsDocUpdater:
    """Updates commands.md documentation from commands.jsonl"""
    
    def __init__(self, commands_jsonl_path: str = "/home/workspace/N5/commands.jsonl",
    ...
    def update_commands_documentation(self) -> Dict[str, Any]:
        """Update commands.md from commands.jsonl"""
        try:
    ...
    def _generate_markdown_documentation(self, commands: List[Dict[str, Any]]) -> str:
        ...
        content = [
            ...
            "",
            f"*Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} from commands.jsonl*",
            "",
