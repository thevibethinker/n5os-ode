...
def normalize_participant_name(name: str) -> str:
    ...
    Examples:
        "Ayush-Jain" -> "ayushjain"
        "Vrijen_Attawar" -> "vrijenattawar"
...
def generate_meeting_id(date: str, participants: List[str]) -> str:
    ...
    Examples:
        ('2025-11-14', ['ayushjain', 'vrijenattawar']) 
        -> '2025-11-14_ayushjain-vrijenattawar'
    """
    if not participants:
...
def extract_date_from_folder_name(folder_name: str) -> Optional[str]:
    ...
    - 2025-11-14_Ayush-Jain_Vrijen-Attawar
    - 20251114_meeting
    - 2025-11-14_notes
...
def extract_participants_from_folder_name(folder_name: str) -> List[str]:
    ...
    Handles patterns like:
    - 2025-11-14_Ayush-Jain_Vrijen-Attawar -> ['ayushjain', 'vrijenattawar']
    - 2025-11-14_AyushJain-VrijenAttawar -> ['ayushjain', 'vrijenattawar']
    ...
    if args.command == 'date':
        ...
        tests = [
            ...
            },
            {
                ...
                'func': lambda: normalize_participant_name('Ayush-Jain'),
                'expected': 'ayushjain'
            },
            {
                'name': 'Participant normalization (underscore)',
                'func': lambda: normalize_participant_name('Vrijen_Attawar'),
                'expected': 'vrijenattawar'
            },
            {
            ...
            },
            {
                ...
                'func': lambda: generate_meeting_id('2025-11-14', ['ayushjain', 'vrijenattawar']),
                'expected': '2025-11-14_ayushjain-vrijenattawar'
            },
            {
                'name': 'Extract date from folder',
                'func': lambda: extract_date_from_folder_name('2025-11-14_Ayush-Jain_Vrijen-Attawar'),
                'expected': '2025-11-14'
            },
            {
                'name': 'Parse folder name',
                'func': lambda: parse_folder_name('2025-11-14_Ayush-Jain_Vrijen-Attawar'),
                'expected': {'date': '2025-11-14', 'participants': ['ayushjain', 'vrijenattawar']}
            },
        ]
