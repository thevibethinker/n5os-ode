#!/usr/bin/env python3
"""
Test Suite for Executable Manager
...
@pytest.fixture
def temp_db():
    """Create temporary database for testing with full schema including triggers."""
    ...
    conn.execute("""
        CREATE VIRTUAL TABLE IF NOT EXISTS executables_fts USING fts5(
            id, name, description, category, tags, content='executables', content_rowid='rowid'
        )
    """)
