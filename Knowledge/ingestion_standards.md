...
## Purpose
Establish what information is ingested into the N5 knowledge reservoirs. The goal is to build a complete understanding of V (the user) and Careerspan, focusing on biographical, historical, and strategic aspects that inform ongoing work and decision-making.
...
- Careerspan company details: history, strategy, principles, culture, products/services
- Strategic information: long-term goals, market positioning, competitive advantages
- Historical context: key events, decisions, pivots that shaped V or Careerspan
...
- **Collectively Exhaustive**: Cover all aspects of V and Careerspan without gaps
...
- Facts should tag related entities (e.g., `person:V`, `company:Careerspan`)
