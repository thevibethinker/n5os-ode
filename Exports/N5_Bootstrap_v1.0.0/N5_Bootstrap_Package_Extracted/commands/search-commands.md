...
- `--category` (optional): Filter by category (system, [COMPANY], core, personal, etc.)
...
```bash
python3 /home/workspace/N5/scripts/n5_search_commands.py meeting --category [COMPANY]
```
Returns meeting-related commands in the [COMPANY] category.
...
- `[COMPANY]` - Company-specific commands (timeline, meetings)
