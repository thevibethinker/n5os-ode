...
### Phase 1: Exploration
- [x] Archives extracted to `source/extracted/` (if applicable)
...
- [x] Timestamps parsed correctly (check MIN/MAX)
...
- [x] Can answer time-based questions (trends, by month, etc.)
