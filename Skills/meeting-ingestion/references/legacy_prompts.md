...
### Examples
```
2025-01-15_UserOne_UserTwo
2025-01-15_UserOne_UserTwo_[M]
2025-01-15_UserOne_UserTwo_[B]
2025-01-15_UserOne_UserTwo_[C]
...
3. **Thin wrappers** - Skill orchestrates existing N5/scripts
...
- `N5/builds/meeting-skill-migration/` - Superseded by `meeting-ingestion-skill`
