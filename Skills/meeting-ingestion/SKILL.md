...
Failed checks trigger escalation to the HITL queue (`N5/review/meetings/hitl-queue.jsonl`) with priority levels:
...
Drive folder ID stored in: `N5/config/drive_locations.yaml`
...
python3 Skills/meeting-ingestion/scripts/meeting_cli.py process \
    "/home/workspace/Personal/Meetings/Inbox/2026-01-26_David-x-Careerspan" \
    --blocks B01,B05,B08
```
