#!/usr/bin/env python3
"""GA4 Analytics CLI — Pull traffic stats for vrijenattawar.com."""
...
DEFAULT_HOST = "www.vrijenattawar.com"
...
def main():
    parser = argparse.ArgumentParser(
        description="GA4 Analytics CLI — Pull traffic stats for vrijenattawar.com"
    )
