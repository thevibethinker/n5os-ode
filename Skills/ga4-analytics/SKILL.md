---
name: ga4-analytics
description: Pull Google Analytics 4 traffic stats for V's personal website (vrijenattawar.com). Supports overall traffic, specific page tracking (e.g. /mind), breakdowns by source/device/date, and custom date ranges.
...
| `--host HOSTNAME` | Filter to specific hostname | www.vrijenattawar.com |
