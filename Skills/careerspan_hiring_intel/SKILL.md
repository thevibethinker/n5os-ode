---
name: careerspan-hiring-intel
created: 2026-02-06
last_edited: 2026-02-08
version: 1.1
provenance: con_JYayBp0LOozCjnVT
description: |
  Shared library for Careerspan Hiring Intelligence. Contains canonical implementations
  of Hiring POV generation and related employer analysis operations.
  
  Ensures consistent inputs/outputs across all Careerspan skills.
compatibility: Created for Zo Computer
metadata:
  author: va.zo.computer
---
# Careerspan Hiring Intelligence

## Purpose

This skill provides **canonical implementations** for hiring-related intelligence operations used across the Careerspan pipeline:
...
- `careerspan-jd-intake`: Primary generation when JDs arrive
...
```json
{
  ...
  "_meta": {
    ...
    "role_title": "string",
    "source": "careerspan_hiring_intel.hiring_pov.generate_hiring_pov",
    "jd_length": 1234
  }
}
```
...
```
Skills/careerspan_hiring_intel/
├── SKILL.md                          # This file
├── scripts/
...
Import from any Careerspan skill:
