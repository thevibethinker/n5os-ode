...
def check_submissions(form_id, account):
    ...
    fillout_client = Path("/home/workspace/Skills/dynamic-survey-analyzer/scripts/fillout_client.py")
...
def trigger_refresh(form_id, account, screening_question, screening_exclude):
    ...
    analysis_dir = Path(f"/home/workspace/Datasets/survey-analyses/{form_id}")
    ...
    dashboard_script = Path("/home/workspace/Skills/dynamic-survey-analyzer/scripts/generate_dashboard.py")
