...
**Action:**
```bash
python3 {{WORKSPACE}}/N5/scripts/debug_logger.py append \
  --convo-id <current> \
...
```bash
python3 {{WORKSPACE}}/N5/scripts/debug_logger.py patterns \
...
```bash
python3 {{WORKSPACE}}/N5/scripts/debug_logger.py recent \
