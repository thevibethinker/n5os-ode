...
------------------------------
Shared module for generating Hiring POVs across all Careerspan skills.
Ensures consistent input/output schema regardless of calling context.

Used by:
- careerspan-jd-intake: Primary POV generation when JDs come in
...
def generate_hiring_pov(
    ...
    This is the canonical function used across all Careerspan skills.
    ...
    result["_meta"] = {
        ...
        "source": "careerspan_hiring_intel.scripts.hiring_pov.generate_hiring_pov",
