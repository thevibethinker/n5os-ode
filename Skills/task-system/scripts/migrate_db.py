...
# Paths
N5_TASKS_DB = Path("/home/workspace/N5/task_system/tasks.db")
N5_ACTION_DB = Path("/home/workspace/N5/task_system/action_conversations.db")
UNIFIED_DB = Path("/home/workspace/Skills/task-system/data/tasks.db")
