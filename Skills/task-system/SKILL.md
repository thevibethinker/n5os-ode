...
2. **During Day**: Open the file, check boxes as you complete tasks
   ```markdown
   - [x] #42 **Draft investor memo** (30min) — Careerspan
   - [ ] #43 **Review competitor pricing** (20min) — Careerspan
   ```
...
Delivery evidence:
- Created: a draft document in the relevant workspace folder
...
2. For each action item, extract and structure:
   ...
   - **domain**: Infer from meeting context (careerspan, zo, personal)
