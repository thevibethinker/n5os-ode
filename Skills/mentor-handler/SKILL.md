---
name: mentor-handler
description: Handle escalation requests from zoputer instances and provide thoughtful mentor guidance based on precedent and context analysis
compatibility: Created for Zo Computer
metadata:
  author: va.zo.computer
  version: "1.0.0"
  build_ref: zoputer-autonomy-v2/D2.3
---

# Mentor Handler

VA-side handler for receiving and responding to escalation requests from zoputer instances.

## Purpose

This skill processes escalation requests from client Zo instances (zoputers) and provides mentor guidance based on:
...
Activated when receiving mentor_escalation type requests via the VA API bridge from zoputer instances.
...
- Specific learning guidance for zoputer
- Confidence assessment
