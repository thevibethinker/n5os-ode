...
const PORT = parseInt(process.env.PORT || process.env.VAPI_HOTLINE_PORT || "8773");
...
const conceptFiles = {
  ...
  "agents": "96-zo-platform/agents.md",
  "zo-agents": "96-zo-platform/agents.md",
  "scheduled-agents": "96-zo-platform/agents.md",
  "automation": "96-zo-platform/agents.md",
  "automations": "96-zo-platform/agents.md",
    ...
    try {
      ...
      if (messageType === "assistant-request") {
        ...
        const response = {
          assistant: {
            name: "Zoseph",
            firstMessage: "Hey — this is Zoseph on the Vibe Thinker Hotline, built by the Vibe Thinker on Twitter. This is a tool to help Zo Computer users make the most of this product. If at any point you want a real person's help from V, just say so and I'll connect you. So — are you exploring what Zo can do, or working on something specific?",
            ...
            analysisPlan: {
              summaryPrompt: "Summarize this Vibe Thinker Hotline call in 2-3 sentences. Focus on: the caller's career question or challenge, what advice or frameworks Zoseph provided, and whether the caller left with a concrete next step or actionable insight.",
              ...
              structuredDataSchema: {
                ...
                properties: {
                  call_category: {
                    type: "string",
                    enum: ["career_transition", "job_search", "interview_prep", "negotiation", "leadership", "general_advice", "venting", "unclear"],
                    description: "Primary category of the career question"
                  },
                  caller_profession: {
                    type: "string",
                    description: "Caller's current role or field if mentioned"
                  },
                  ...
                  primary_challenge: {
                    type: "string",
                    description: "The main problem or question the caller brought"
                  },
                  frameworks_used: {
                    type: "array",
                    items: { type: "string" },
                    description: "Any coaching frameworks or mental models Zoseph referenced"
                  },
                  had_clear_next_step: {
                    type: "boolean",
                    description: "Did the caller leave with a concrete action to take?"
                  },
                  ...
                  emotional_state: {
                    type: "string",
                    enum: ["frustrated", "anxious", "curious", "motivated", "neutral", "overwhelmed"],
                    description: "Caller's apparent emotional state during the call"
                  },
                  interruption_issues: {
                    type: "boolean",
              ...
              successEvaluationPrompt: "Evaluate this Vibe Thinker Hotline call. A successful call means: (1) Zoseph correctly identified the caller's core career challenge, (2) provided relevant, practical advice grounded in career coaching principles, (3) listened actively without interrupting or lecturing, (4) ended with a concrete next step the caller can take, (5) did NOT promise to connect with V or offer things outside his scope, (6) maintained warmth without being condescending. Rate on a 1-10 scale. Deduct points for: generic advice not tailored to the caller, interruptions, promising human follow-up, overwhelming with too many options, or failing to validate the caller's concerns before advising.",
