...
description: >
  ...
  Use when starting any Pulse build or when V describes a new feature/system to build.
...
- When V says "I want to build X" or describes a new feature/system
...
```
V describes intent ("I want to build X")
...
Present them to V for review:
- Are these the right scenarios?
- Anything missing?
- Are the Verify clauses executable?

### Round 5: Approval
V approves or modifies scenarios. Output the final scenario set.
...
- <Thing that needs V's decision before planning>
...
- See `file 'Skills/pulse/references/interview-protocol.md'` Question 7 for how scenarios integrate with the interview
...
See `file 'Skills/spec-writing/references/scenario-patterns.md'` for common scenario patterns by build type.
